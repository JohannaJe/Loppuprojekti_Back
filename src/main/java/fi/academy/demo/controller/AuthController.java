...
import fi.academy.demo.payload.ApiResponse;
import fi.academy.demo.payload.JwtAuthenticationResponse;
import fi.academy.demo.payload.LoginRequest;
import fi.academy.demo.payload.SignUpRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        System.out.println("hulabalooooooo");
